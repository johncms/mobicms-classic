...
switch ($mod) {
    case 'new':
        ...
        if (isset($_POST['submit'])) {
            ...
            echo '<form action="index.php?act=ipban&amp;mod=new" method="post">' .
                ...
                '<p><h3>' . _t('Reason') . '</h3>' .
                '&nbsp;<textarea rows="' . $userConfig->fieldHeight . '" name="reason"></textarea></small></p>' .
    ...
    default:
        ...
        if ($total > $userConfig->kmess) {
            echo '<div class="topmenu">' . $tools->displayPagination('index.php?act=ipban&amp;', $start, $total, $userConfig->kmess) . '</div>';
