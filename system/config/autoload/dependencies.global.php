...
return [
    'dependencies' => [
        'factories' => [
            ...
            Mobicms\Http\ServerRequest::class       => Mobicms\Http\ServerRequestFactory::class,
        ...
        'aliases' => [
            Psr\Http\Message\ServerRequestInterface::class => Mobicms\Http\ServerRequest::class,
        ],
    ],
];
